...
public class Tests_prac02_01 {
	...
	public void testConstructoresCircunferencia() {
		...
		assertEquals("El radio de una circunferencia construida con el constructor vacío debe ser 0", 0, c.getRadio(),0);
		
		Circunferencia c1 = new Circunferencia(10);
		assertEquals("El radio de la circunferencia c1 debe ser 10", 10, c1.getRadio(),0);
