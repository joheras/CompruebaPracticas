...
public class Tests_prac05_01_Punto {

	@Test
	public void testConstructores() {
		Punto p = new Punto();
		assertEquals("La coordenada x de un punto construido con constructor vacío debe ser 0", 0, p.getX(),0);
		assertEquals("La coordenada y de un punto construido con constructor vacío debe ser 0", 0, p.getY(),0);
		
		Punto p1 = new Punto(5.0,7.0);
		assertEquals("La coordenada x del punto p1 deber ser 5.0", 5.0, p1.getX(),0.0001);
		assertEquals("La coordenada y del punto p1 deber ser 7.0", 7.0, p1.getY(),0.0001);
	}
	...
	public void testGetSetX() {
		...
		Punto p1 = new Punto(5.0,7.0);
		p1.setX(3.2);
		assertEquals("La coordenada x del punto p1 deber ser 3.2", 3.2, p1.getX(),0.0001);
		assertEquals("La coordenada y del punto p1 deber ser 7.0", 7.0, p1.getY(),0.0001);
	}
	...
	public void testGetSetY() {
		...
		p1.setY(3.2);
		assertEquals("La coordenada x del punto p1 deber ser 5.0", 5.0, p1.getX(),0.0001);
		assertEquals("La coordenada y del punto p1 deber ser 3.2", 3.2, p1.getY(),0.0001);
	}
	...
	public void testNorma() {
		...
		assertEquals("La norma de p1 es 8.1541", 8.1541, p1.norma(),0.001);
		assertEquals("La norma de p2 es 0", 0, p2.norma(),0.001);
		assertEquals("La norma de p3 es 1", 1, p3.norma(),0.001);
	...
	public void testToString() {
		...
		assertEquals("P1 se muestra bien", true, p1.toString().contains(Double.toString(p1.getCoordRadial())));
		assertEquals("P1 se muestra bien", true, p1.toString().contains(Double.toString(p1.getCoordAngular())));

		assertEquals("P2 se muestra bien", true, p2.toString().contains(Double.toString(p2.getCoordRadial())));
		assertEquals("P2 se muestra bien", true, p2.toString().contains(Double.toString(p2.getCoordAngular())));
		
		assertEquals("P3 se muestra bien", true, p3.toString().contains(Double.toString(p3.getCoordRadial())));
		assertEquals("P3 se muestra bien", true, p3.toString().contains(Double.toString(p3.getCoordAngular())));
	}
}
