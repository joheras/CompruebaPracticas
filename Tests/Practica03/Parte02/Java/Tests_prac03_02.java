...
public class Tests_prac03_02 {
	
	@Test
	public void testInicialContadorPuntos() {
		assertEquals("Al principio no hay ningún punto construido", 0, Punto.getContadorPuntos());
	}

	@Test
	public void testInicialContadorPolares() {
		assertEquals("Al principio no hay ninguna llamada a los métodos de polares", 0, Punto.getContadorPolares());
	}
	...
	@Test
	public void testContadorPuntos() {

		assertEquals("Hasta ahora se han construido 7 puntos", 16, Punto.getContadorPuntos());
		
	}
	

	@Test
	public void testContadorPolares() {
		assertEquals("Hasta ahora se ha llamado 18 veces a las operaciones de polares", 18, Punto.getContadorPolares());
	}
